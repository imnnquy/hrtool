...
<html>
        ...
        <script>
			...
			$('#cbo-vacancy-status').editableSelect({
              ...
              //resize right column to match height with left column => fix vertical divider
        	    ...
        	    $('.ico-20.add-row').click(function(){
        	    	$('.io-editable-list').append('<div class="row"><span class="col"><select id="cbo-skill-1" class="editable-select"><option value="Java">Java</option></select></span><span class="col"><select id="cbo-skill-level-1" class="editable-select"><option value="Beginner">Beginner</option></select></span><span class="ico-20 remove-row"></span></div>');
        	    });  	
        	});
	...
	<body>
	<form:form commandName="vacancy" id="createForm">
        <div>
            <div>
					...
					<div class="pad-10">
						<div class="io-panel panel-create-vacancy">
							<div class="io-panel-header" >
								<h3 class="txtTitle-1">Create New Vacancy</h3>
								<div class="float-r"> 
									<a href="javascript:createForm.submit();" class="io-button-highlight medium">
										<span>SAVE</span>
									</a> 
									<a href="04_vacancy" class="io-button-standard medium">
										<span>CANCEL</span>
									</a> 
								</div> 
							</div>
							...
							<div class="io-panel-body">
                                <div class="col-4 col-36 left">
        								...
        								<div class="pad-20">
        									<table class="io-table-input vertical">
        	                                    <tbody>
                                                    ...
                                                    <tr>
        	                                            <td class="data">
        	                                              <form:input path="number" tfype="text" class="io-txt-normal" style="width: 198px;"/>
        	                                            </td>
        	                                        </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <select name="workingLocationId" id="cbo-working" class="editable-select" style="width: 173px;">
                                                    ...
                                                    <tr>
        	                                        	<td class="data">
        	                                              <input type="text" name="startDate" class="io-date-normal" id="start-date" style="width: 178px;"/>
        	                                            </td>
        	                                        </tr>
        	                                        <tr>
                                                    ...
                                                    <tr>
        	                                        	<td class="data">
        	                                              <input type="text" name="endDate" class="io-date-normal" id="end-date" style="width: 178px;"/>
        	                                            </td>
        	                                        </tr>
                                    ...
                                    <tr>
                                                        <td class="data">
                                                        <form:select path="status" items="${Status}" itemValue="statusId" itemLabel="statusName" id="cbo-vacancy-status" class="editable-select">
                                                        </form:select>
                                                        </td>
                                                  </tr>
        	                                    </tbody>
                                        ...
                                        <div class="pad-20">
                                            <table class="io-table-input vertical">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="data">
                                                          <div class="io-editable-list">
                                                            <div class="row">
                                                              <span class="col"><select name="vacancySkills.skill.skillMaster"  id="cbo-skill-1" class="editable-select">
                                                                                                                  <option value="Java">Java</option>
                                                                                                                </select></span>
                                                              <span class="col"><select name="vacancySkills.skill.skillLevel" id="cbo-skill-level-1" class="editable-select">
                                                            ...
                                                            <div class="row">
                                                              <span class="col"><select name="vacancySkills.skill.skillMaster" id="cbo-skill-2" class="editable-select">
                                                                                                                  <option value="CSS">CSS</option>
                                                                                                                </select></span>
                                                              <span class="col"><select name="vacancySkills.skill.skillLevel" id="cbo-skill-level-2" class="editable-select">
                                                    ...
                                                    <tr>
                                                        <td class="data"><textarea name="description" class="io-ta-normal">- Having a creative thinking
- Strong word Ethic
